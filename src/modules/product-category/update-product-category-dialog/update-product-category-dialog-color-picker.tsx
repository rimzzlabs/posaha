...
export function UpdateProductCategoryDialogColorPicker() {
  let form = useFormContext<z.infer<typeof updateCategorySchema>>()

  let disabledInteractive = form.formState.isSubmitting
